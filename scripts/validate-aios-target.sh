...
require_file ".github/workflows/build-aios-base-images.yml"
...
require_executable "packages/target-aios-gui/tools/flash"
...
require_file "packages/target-aios-gui/buildroot/kernel/aios_gui_pi3bplus_7touch.fragment"
require_file "packages/target-aios-gui/buildroot/overlays/rootfs/init"
require_file "packages/target-aios-gui/buildroot/overlays/rootfs/etc/init.d/S99aios-launch"
require_file "profiles/rpi/profile.toml"
require_file "profiles/pi3bplus/profile.toml"
require_file "profiles/pi3bplus-7touch/profile.toml"
require_file "profiles/pi3bplus-7touch/README.md"
require_file "profiles/pi4/profile.toml"
require_file "profiles/pi5/profile.toml"
...
sh -n "${ROOT_DIR}/packages/target-aios-gui/tools/flash"
